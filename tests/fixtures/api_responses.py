"""
Golden fixture payloads - real, hand-shaped API response data, carried over
from the pre-refactor mocks rather than regenerated. These are the actual
constants the raw client-library doubles in mocks/raw_spotify.py,
mocks/raw_musicbrainz.py, and mocks/raw_lastfm.py return by default.

Each of these deliberately keeps a few real-world edge cases intentionally
baked in - don't "clean these up" without checking what they're covering:
  - MB_ARTIST_BY_ID has a non-ASCII alias-list entry (a Japanese transliteration)
    and a non-ASCII begin-area name ("K\u00f6ln") - unicode-handling coverage
    for mapping.py/resolution.py's tag/name plumbing.
  - SPOTIFY_QUEUE/SPOTIFY_CURRENT_PLAYBACK use a different artist (New Order /
    Pink Floyd / Mote) than the rest (CAN) - useful for catching code that
    accidentally assumes "the" artist is consistent across calls.
  - SPOTIFY_SEARCH's second result deliberately shares a word ("Spoon") with
    the first result's track name but is a different artist entirely - regression
    coverage for resolution.py's cross-referencing accidentally matching on
    substring rather than identity.

strategies/apis.py builds structural variations (page counts, optional-field
presence, artist-count, multi-artist tracks, unicode name variants) on top of
these templates rather than generating raw response shapes from scratch - see
    ...
    "tracks": [
        {
            ...
            "external_urls": {"spotify": "https://open.spotify.com/track/4zdsBics0asw0gj4L5wu5v"},
        ...
        },
        {
            ...
            "external_urls": {"spotify": "https://open.spotify.com/track/4bYqOnDzT5OpmfA9apUxyj"},
...
SPOTIFY_TRACK = {
    "album": {
        ...
        "external_urls": {"spotify": "https://open.spotify.com/album/1MLxE2czxo5A9OVZ2m8FV3"},
        "href": "https://api.spotify.com/v1/albums/1MLxE2czxo5A9OVZ2m8FV3",
        "id": "1MLxE2czxo5A9OVZ2m8FV3",
        "name": "Ege Bamyasi (Remastered)",
        "release_date": "1972-01-01",
    ...
    "items": [
        {
            ...
            "duration_ms": 605000,
            "explicit": False,
            "external_urls": {"spotify": "https://open.spotify.com/track/59aSAf42HataSl7leXNtAa"},
        ...
        },
        {
            ...
            "duration_ms": 907437,
            "explicit": False,
            "external_urls": {"spotify": "https://open.spotify.com/track/0yG6nGRX6feqo8QTOVWKnZ"},
    ...
    "items": [
        {
            "album_type": "album",
            "total_tracks": 5,
            "external_urls": {"spotify": "https://open.spotify.com/album/6u9vLxqiEzXAd9VE5zi2EN"},
        ...
        },
        {
            "album_type": "album",
            "total_tracks": 4,
            "external_urls": {"spotify": "https://open.spotify.com/album/5Ju5X4yL4nwWpflI0xlTgB"},
...
SPOTIFY_CURRENT_PLAYBACK = {
    ...
    "item": {
        "album": {
            ...
            "external_urls": {"spotify": "https://open.spotify.com/album/6iHuSGy6pq4tNGFV3ZVPtl"},
        ...
        "external_urls": {"spotify": "https://open.spotify.com/track/6hHc7Pks7wtBIW8Z6A0iFq"},
...
SPOTIFY_QUEUE = {
    "queue": [
        ...
        },
        {
            ...
            "external_urls": {"spotify": "https://open.spotify.com/track/040bc9LaTiSb0EwAJ01brc"},
            ...
            "artist-credit": [
                {
                    ...
                    "artist": {
                        ...
                        "alias-list": [{"sort-name": "カン", "alias": "カン"}],
                    },
                }
            ],
        }
